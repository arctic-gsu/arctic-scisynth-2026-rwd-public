...
REQUIRED_FILES = [
    ...
    (PROCESSED, "rail_stops.csv",
     "Regenerate via planning/phase0_dryrun/phase0_full_pipeline.ipynb."),
    ...
    (CHECKPOINTS, "day1_output_stops.csv",
     "Re-run solutions/day1_explore_marta.ipynb."),
    (CHECKPOINTS, "day2_output_cleaned_ridership.csv",
     "Re-run solutions/day2_cleaning_ridership.ipynb."),
    (CHECKPOINTS, "day2_output_station_freq_clean.csv",
     "Re-run solutions/day2_cleaning_ridership.ipynb."),
    (CHECKPOINTS, "day3_output_eda_summary.csv",
     "Re-run solutions/day3_eda_and_mapping.ipynb."),
    (CHECKPOINTS, "day4_output_demand_estimates.csv",
     "Re-run solutions/day4_demand_estimation.ipynb."),
]
